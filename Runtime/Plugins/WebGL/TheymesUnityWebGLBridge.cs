...
namespace Theymes
{
    public static class TheymesUnityWebGLBridge
    {
        ...
        private static extern void TheymesInitialize(string token, string domain);
        ...
        [DllImport("__Internal")]
        private static extern string TheymesGetSdkVersion();
        ...
        [DllImport("__Internal")]
        private static extern string TheymesGetLanguage();

        [DllImport("__Internal")]
        private static extern void TheymesSetLanguage(string language);

        [DllImport("__Internal")]
        private static extern string TheymesGetSignedMetadataToken();

        [DllImport("__Internal")]
        private static extern void TheymesSetSignedMetadataToken(string token);

        [DllImport("__Internal")]
        private static extern string TheymesGetPlayer();

        [DllImport("__Internal")]
        private static extern void TheymesSetPlayer(string player);

        [DllImport("__Internal")]
        private static extern string TheymesGetTags();
        ...
        [DllImport("__Internal")]
        private static extern string TheymesGetFields();
        ...
        {
            TheymesInitialize(token, domain);
        }
        ...
        {
            return TheymesGetSignedMetadataToken();
        }
