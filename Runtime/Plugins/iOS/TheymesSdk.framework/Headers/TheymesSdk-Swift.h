...
#ifndef THEYMESSDK_SWIFT_H
#define THEYMESSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TheymesSdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
+ (void)openResource:(NSString * _Nonnull)resource;
+ (void)close;
...
+ (NSInteger)getUnansweredMessageCount SWIFT_WARN_UNUSED_RESULT;
+ (void)recordRetention;
+ (void)reset;
+ (NSString * _Nullable)getLanguage SWIFT_WARN_UNUSED_RESULT;
+ (void)setLanguage:(NSString * _Nullable)language;
+ (NSString * _Nullable)getSignedMetadataToken SWIFT_WARN_UNUSED_RESULT;
+ (void)setSignedMetadataToken:(NSString * _Nullable)token;
+ (NSDictionary * _Nullable)getPlayer SWIFT_WARN_UNUSED_RESULT;
+ (void)setPlayer:(NSDictionary * _Nullable)player;
+ (NSArray<NSString *> * _Nonnull)getTags SWIFT_WARN_UNUSED_RESULT;
...
+ (void)removeFields:(NSArray<NSString *> * _Nonnull)fields;
+ (void)removeAllFields;
+ (void)enableLogging;
+ (void)disableLogging;
+ (BOOL)isYoungPlayer SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP10TheymesSdk15TheymesDelegate_")
@protocol TheymesDelegate
@optional
- (void)didOpen;
- (void)didClose;
